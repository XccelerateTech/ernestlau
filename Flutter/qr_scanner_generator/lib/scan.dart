...
class _ScanState extends State<ScanScreen> {
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Chip(
                        ...
                        label: Text(barcode == "" ? "Merchant Only" : barcode,
                        softWrap: true,),
                        backgroundColor: barcode != "Order Completed!" ? Colors.red[200] : Colors.teal[100],
  ...
  Future scan() async {
    try {
      ...
      Dio dio = new Dio();
      Response response =
          await dio.get("http://192.168.1.135:6060/api/booking/${scanResult}");
